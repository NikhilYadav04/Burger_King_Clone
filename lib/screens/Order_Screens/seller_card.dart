...
import 'package:burger_king_/screens/Order_Screens/order_page.dart';
...
class SellerCard extends StatefulWidget {
  ...
  SellerCard(
      ...
      required this.CartDesc,
      required this.MediumProductPrice,
      required this.LargeProductPrice});
        ...
        children: [
          GestureDetector(
            onTap: () {
              setState(() {
                index = 1;
                Cost = "₹ ${widget.OriginalProductPrice}/-";
                ProductPrice = widget.OriginalProductPrice;
                MealType = "BURGER ONLY";
              });
            },
            child: Container(
              height: 128,
          ...
          GestureDetector(
            onTap: () {
              setState(() {
                ...
                ProductPrice = widget.MediumProductPrice;
                MealType = "MEDIUM MEAL";
              });
            },
            child: Container(
              height: 128,
          ...
          GestureDetector(
            onTap: () {
              setState(() {
                ...
                ProductPrice = widget.LargeProductPrice;
                MealType = "LARGE MEAL";
              });
            },
            child: Container(
